...
<main class="bmd-layout-content">
			<div class="container-fluid ">
				...
				<div class="card-header">ویرایش اکانت ها</div>
				<div class="row m-1 mb-2">
					...
					<div class="col-md-12 mt-4">
                        ...
                        <input type="text"  value="{{$account->description}}"   name="description" class="form-control">
                    </div>
					<div class="col-md-12 mt-4">
						<label for="">تاریخ </label>
                        <input type="date"  value="{{$account->date}}"   name="date" class="form-control">
                    </div>
				</div>
