...
<main class="bmd-layout-content">
			<div class="container-fluid ">
				...
				<form action="{{route('editMedicineCategory')}}" method="post">
				@csrf
                <input type="hidden" name="medicineCat_id"  value="{{$catagory->medicineCat_id}}">
				<div class="card" style="margin-top:40px;">
				<div class="card-header">ویرایش کتگوری دارو ها</div>
